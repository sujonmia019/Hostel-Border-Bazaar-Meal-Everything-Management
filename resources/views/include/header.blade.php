    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('borders*') ? 'active' : '' }}" href="{{ route('app.hostel-admin.borders.index') }}"> <i class="fas fa-users fa-sm"></i> Borders</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('bills*') ? 'active' : '' }}" href="{{ route('app.hostel-admin.bills.index') }}"> <i class="fas fa-bank fa-sm"></i> Bill</a>
                </li>
                @endif
