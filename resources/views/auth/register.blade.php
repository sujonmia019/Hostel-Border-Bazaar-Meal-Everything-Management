                ...
                <div class="card-body text-center p-4">
                    ...
                    <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 justify-content-center">
                            <div class="col-md-12">
                                <input type="text" name="hostel_name" value="{{ old('hostel_name') }}"  class="form-control form-control-sm rounded-0 shadow-none" id="name" placeholder="Hostel Name">
                                @error('hostel_name')
                                    <small class="d-block text-danger text-start">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                <input type="text" name="hostel_address" value="{{ old('hostel_address') }}"  class="form-control form-control-sm rounded-0 shadow-none" id="name" placeholder="Hostel Address">
                                @error('hostel_address')
                                    <small class="d-block text-danger text-start">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                <input type="file" name="logo" value="{{ old('logo') }}" class="form-control form-control-sm rounded-0 shadow-none" id="logo">
                                @error('logo')
                                    <small class="d-block text-danger text-start">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                <input type="text" name="name" value="{{ old('name') }}"  class="form-control form-control-sm rounded-0 shadow-none" id="name" placeholder="Your Name">
                                @error('name')
                                    <small class="d-block text-danger text-start">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                <input type="text" name="username" value="{{ old('username') }}"  class="form-control form-control-sm rounded-0 shadow-none" id="username" placeholder="Username">
                                @error('username')
                                    <small class="d-block text-danger text-start">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                <input type="email" name="email" value="{{ old('email') }}"  class="form-control form-control-sm rounded-0 shadow-none" id="email" placeholder="Email">
                                @error('email')
                                    <small class="d-block text-danger text-start">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                <input type="password" name="password"  class="form-control form-control-sm rounded-0 shadow-none" id="password" placeholder="Password">
                                @error('password')
                                    <small class="d-block text-danger text-start">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                <input type="password" name="password_confirmation"  class="form-control form-control-sm rounded-0 shadow-none" id="password_confirmation" placeholder="Confirm Password">
